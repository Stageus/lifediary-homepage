...
const posts = [
  { id: 1, date: new Date(2024, 7, 14), isPublic: false },
  { id: 2, date: new Date(2024, 7, 15), isPublic: true },
  { id: 3, date: new Date(2024, 7, 16), isPublic: false },
  { id: 4, date: new Date(2024, 7, 16), isPublic: false },
  { id: 5, date: new Date(2024, 7, 16), isPublic: true },
  { id: 6, date: new Date(2024, 7, 16), isPublic: false },
  { id: 7, date: new Date(2024, 7, 16), isPublic: true },
];
...
export const useDivideList = () => {
  ...
  const handleSearch = () => {
    if (startDateSelected === false || endDateSelected === false) {
      ...
      const searched = publicPosts.filter((e) => {
